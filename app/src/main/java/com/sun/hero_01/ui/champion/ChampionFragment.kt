...
class ChampionFragment : BaseFragment(), ChampionContract.View {

    private val adapter by lazy { ChampionAdapter() }
    private val presenter = ChampionPresenter(HeroRepository.getInstance(HeroRemoteDataSource.getInstance()))
